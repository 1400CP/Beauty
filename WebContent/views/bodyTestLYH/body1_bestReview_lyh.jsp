			...
			<table id="table_bestReview">
				<thead>
					<tr>
						<td colspan="15" align="center"
							style="height: 20px; color: black;"><h1>Best Review</h1></td>
					</tr>
					<tr>
				...
				<tbody>
					<td onclick="location.href='http://www.daum.net'"><img
						src="<%= contextPath %>/resources/images/medicube.png" alt=""
						class="bestReviewImg1"></td>
					...
					<tr>
						...
						<td onclick="location.href='http://www.daum.net'"><img
							src="<%= contextPath %>/resources/images/bestreview1.png" alt=""
						...
						<td colspan="15" align="center">
							<button class=bestReviewBtn>
								<a href="<%= contextPath %>/review.li"
									style="text-decoration-line: none;"> 더보기 </a>
							</button>
						</td>
					...
					<tr style="height: 40px;">
						<td colspan="15" align="center"><img
							src="<%= contextPath %>/resources/images/bestreview3.png" alt=""
